...
const TradingViewChart = dynamic(
  () => import("@/Components/TradingChartsControll/TradingViewChart"),
  { ssr: false }
);
        ...
        <div className="fixed bottom-0 left-0 xsm:px-6 xxsm:px-2 sm:px-8 md:px-9 px-9 w-full flex items-center justify-between bg-black-300 py-3 rounded-t-lg">
          ...
          >
            <Image
              src={
                select === "Quotes"
                  ? "/Images/Icons/quotes-active.svg"
            ...
            <small
              className={`font-semibold ${
                select === "Quotes" ? "text-green-500" : "text-gray-300"
              }`}
            >
              Quotes
            </small>
          ...
          >
            ...
            <small
              className={`font-semibold ${
                select === "Chart" ? "text-green-500" : "text-gray-300"
              }`}
            >
              Charts
            </small>
          ...
          >
            <Image
              src={
                select === "Trades"
                  ? "/Images/Icons/trades-active.svg"
            ...
            <small
              className={`font-semibold ${
                select === "Trades" ? "text-green-500" : "text-gray-300"
              }`}
            >
              Trades
            </small>
          ...
          >
            <Image
              src={
                select === "Settings"
                  ? "/Images/Icons/settings-active.svg"
            ...
            <small
              className={`font-semibold ${
                select === "Settings" ? "text-green-500" : "text-gray-300"
              }`}
            >
              Settings
            </small>
