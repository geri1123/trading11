...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="relative xl:grid flex justify-between xl:grid-cols-[200px_2fr_1fr] rounded-20 items-center w-full xl:px-6 lg:px-6 md:px-6 px-3 py-2 bg-black-300">
      ...
      <div className="flex items-center w-full justify-end gap-5">
        <div className="flex flex-row xsm:px-2 xxsm:px-1 py-4 px-3 gap-3 items-center lg:items-start xl:items-start lg:flex-col  lg:py-2 xl:py-2 lg:px-4 xl:px-4 bg-black-700 lg:gap-0 xl:gap-0 rounded-xl">
        ...
        <div className="xl:flex xxl:flex hidden items-center gap-3 relative">
          <button className="flex items-center justify-center p-4 border-none outline-none cursor-pointer w-max rounded-2xl bg-black-700 h-[50px]">
            <Image
