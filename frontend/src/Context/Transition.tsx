...
// const TransitionContext = React.createContext<TransitionContextValue>({ parent: {} });
...
//         ref={nodeRef as any}
//         {...rest}
//         style={{ ...(rest.style || {}), display: !removeFromDom ? "none" : undefined }}
//       >
//         {children}
//       </Component>
//     </ReactCSSTransition>
...
// interface TransitionProps extends Omit<CSSTransitionProps, "show" | "appear"> {
//   show?: boolean;
//   appear?: boolean;
// }
