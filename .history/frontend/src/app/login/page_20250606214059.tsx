...
interface FormData {
  username: string; // use "username" as expected by backend
  password: string;
}
...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Make the request to your Java backend endpoint
      ...
      // Optionally, process the token/roles returned in data if necessary
