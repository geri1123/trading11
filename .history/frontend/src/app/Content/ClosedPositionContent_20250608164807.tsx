      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-max">
          ...
          <thead className="bg-gray-800 border-b border-gray-700">
            <tr>
              <th className="sticky left-0 bg-gray-800 z-20 px-4 py-3 text-left">
          ...
          <tbody className="divide-y divide-gray-700">
            {trades.map((row: any, index: number) => (
              ...
              >
                {/* Instrument */}
                <td className="sticky left-0 bg-gray-900 hover:bg-gray-800 z-10 px-4 py-3">
      ...
      <div className="lg:hidden">
        <div className="space-y-4 p-4">
          {trades.map((row: any, index: number) => (
            <div
              key={row.positionId || row.id || index}
              className="bg-gray-800 rounded-lg p-4 space-y-1"
            >
