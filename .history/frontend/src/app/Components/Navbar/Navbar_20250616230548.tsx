...
import React, { useEffect, useRef, useState, MouseEvent, KeyboardEvent, useContext } from 'react';
...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Transition
        className={`origin-top-right z-30 p-4 h-fit absolute top-full w-[450px] bg-black-700 dark:bg-gray-800 border border-black-300 rounded-xl z-10 shadow-lg overflow-hidden mt-1 right-20`}
        show={dropdownOpen}
      ...
      >
        ...
        >
          ...
          <button className="flex items-center bg-black-300 justify-between w-full p-2 bg-contentBg rounded-xl">
            ...
            <button onClick={handleLogout}  className="flex items-center bg-black-300 justify-between w-full p-2 bg-contentBg rounded-xl">
            <div className="flex items-center gap-2.5">
              <div className="grid bg-violet-10 p-3 bg-themeViolet rounded-xl place-content-center">
