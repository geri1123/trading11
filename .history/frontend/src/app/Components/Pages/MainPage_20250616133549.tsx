...
const MainPage: React.FC = () => {
  ...
  const [liveData, setLiveData] = useState<Record<string, { a?: number; b?: number; spread?: number }>>({});

  // Handle data selection from ChartControll
  const handleDataSelect = (data: SelectedData) => {
    setSelectedData(data);
  };

  // Handle live data updates from ChartControll
  const handleLiveDataUpdate = (data: Record<string, { a?: number; b?: number; spread?: number }>) => {
    setLiveData(data);
  };
          ...
          <div className='all-tradingchart h-full grid grid-cols-[2fr_1fr] gap-3'>
            ...
            <div className='flex flex-col h-full gap-2'>
              <ChartControll 
                ...
                onLiveDataUpdate={handleLiveDataUpdate}
              />
              <BuySell 
                data={selectedData} 
                liveData={liveData}
