...
const BuySell: React.FC<BuySellProps> = ({ data }) => {
  ...
  const getCurrencyFlags = (pair: string) => {
    if (!pair) return { base: '/Images/Icons/gbp.svg', quote: '/Images/Icons/dollar.svg' };
    const currencies = pair.split('/');
    const base = currencies[0]?.toLowerCase();
    const quote = currencies[1]?.toLowerCase();
    const flagMap: Record<string, string> = {
      'gbp': '/Images/Icons/gbp.svg',
      'usd': '/Images/Icons/dollar.svg',
      'eur': '/Images/Icons/eur.svg',
      'jpy': '/Images/Icons/jpy.svg',
      'cad': '/Images/Icons/cad.svg',
      'aud': '/Images/Icons/aud.svg',
      'chf': '/Images/Icons/chf.svg',
      'nzd': '/Images/Icons/nzd.svg',
      'nok': '/Images/Icons/nok.svg',
      'sek': '/Images/Icons/sek.svg',
      'dkk': '/Images/Icons/dkk.svg',
      'czk': '/Images/Icons/czk.svg',
      'hkd': '/Images/Icons/hkd.svg',
      'mxn': '/Images/Icons/mxn.svg',
      'huf': '/Images/Icons/huf.svg',
      'pln': '/Images/Icons/pln.svg',
      'try': '/Images/Icons/try.svg',
      'zar': '/Images/Icons/zar.svg',
      'rub': '/Images/Icons/rub.svg',
      'ils': '/Images/Icons/ils.svg',
      'sgd': '/Images/Icons/sgd.svg',
      'cnh': '/Images/Icons/cnh.svg',
    };
    return {
      base: flagMap[base] || '/Images/Icons/gbp.svg',
      quote: flagMap[quote] || '/Images/Icons/dollar.svg'
    };
  };
    ...
    <div className={`w-full xl:p-3 xxl:p-3.5 p-2.5 overflow-hidden bg-black-300 rounded-20`}>
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2.5">
          <img src={currencyFlags.base} alt="base currency" />
          <p className="leading-none text-white text-14px xl:text-[12px] pt-[2px] font-semibold">
            {selectedData.pair}
          </p>
          <img src={currencyFlags.quote} alt="quote currency" />
        </div>
        <button
