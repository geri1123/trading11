...
const ChartControll: React.FC<ChartControllProps> = ({ onSelect, liveData }) => {
  ...
  return (
    ...
    <thead className="sticky top-0 z-10 bg-black-700">
      <tr>
        <th className="sticky left-0 z-20 bg-black-700 min-w-[120px]">
          <div className="flex items-center justify-between gap-1 py-2 pl-4">
        ...
        {["Ask", "Bid", "Spread", "Day High", "Day Low"].map((title) => (
          <th key={title} className="min-w-[88px] bg-black-700">
            <div className="flex items-center justify-between gap-1 py-2 pl-4">
      ...
      {filteredPairs.map((pair, i) => {
        ...
        return (
          ...
          >
            ...
            <td className="min-w-[88px] py-2 pl-4">
