...
const ChartControll: React.FC<ChartControllProps> = ({ onSelect, liveData }) => {
...
>
  <table className="table-auto w-full border-collapse">
    <thead className="sticky top-0 z-20 bg-black-700">
      <tr className="border-b border-gray-500">
        <th className="sticky left-0 z-30 bg-black-700 min-w-[120px] pl-4 py-2">
        ...
        {/* {["Ask", "Bid", "Spread", "Day High", "Day Low"].map((title) => (
          <th key={title} className="min-w-[88px] pl-4 py-2 bg-black-700">
            <div className="flex items-center justify-between gap-1">
        ...
        {["Ask", "Bid", "Spread", "Day High", "Day Low"].map((title, index, array) => (
  <th key={title} className="min-w-[88px] pl-4 py-2 bg-black-700">
    <div className="flex items-center justify-between gap-1">
      <p className="text-sm font-normal text-white">{title}</p>
    ...
    <tbody className=''>
      {filteredPairs.map((pair, i) => {
        ...
        return (
          ...
          >
            <td className="sticky left-0 z-10 bg-inherit min-w-[120px] pl-4 py-2">
            ...
            <td className="min-w-[88px] pl-4 py-2">
              <p>{data?.a !== undefined ? data.a.toFixed(5) : '-'}</p>
            </td>
            <td className="min-w-[88px] pl-4 py-2">
              <p>{data?.b !== undefined ? data.b.toFixed(5) : '-'}</p>
            </td>
            <td className="min-w-[88px] pl-4 py-2">
              <p>{data?.spread !== undefined ? data.spread.toFixed(5) : '-'}</p>
            </td>
            <td className="min-w-[88px] pl-4 py-2">
              <p>-</p>
            </td>
