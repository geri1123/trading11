        ...
        {activeTab === 'Position' && (
          <>
            <div className="hidden xl:block">
              <PositionContent positionData={trades.map(mapTradeToPositionTradeRow)} loading={loading} refreshData={refreshData} />
            </div>
...
//   const fetchActiveTabTrades = async (reset = false) => {
//     setLoading(true);
//     const data = await fetchTrades({
//       status: getStatusForTab(activeTab),
//       page,
...
//     setTrades(prev => reset ? (data.content || []) : [...prev, ...(data.content || [])]);
...
//     <div className="w-full p-2 lg:p-2 xl:p-2 2xl:p-3 flex flex-col bg-black-300 rounded-20">
//       {/* Top Section */}
//       <div className="top lg:flex items-center grid grid-cols-1 w-full border-b border-gray-500 pb-3 justify-between">
//         {/* Tabs */}
//         <div className="bg-black-700 p-2 flex justify-between gap-4 rounded-xl">
//                    {(['Position', 'Pending', 'Closed Position'] as const).map(tab => (
//             <button
//               key={tab}
//               className={`tab-btn ${activeTab === tab ? 'bg-black-300' : 'bg-black-700'} rounded-lg w-full px-2 py-2 lg:px-4 lg:py-2 xxl:px-4 xxl:py-2 2xl:px-4 2xl:py-2 xl:px-4 xl:py-1 flex items-center gap-2 justify-center`}
...
//             <img src="/Images/Icons/close-all-small.svg" onClick={handleOpenDialog} className='bg-black-200 p-2 rounded-lg' alt="close-all" />
//           </div>
//         </div>

//         {/* Close All Button & Summary */}
//         <div className="flex items-center gap-6">
//           {activeTab === 'Closed Position' && (
//             <div className='hidden lg:flex gap-6'>
//               <div className="flex flex-col">
//                 <p className="text-xs text-white text-opacity-50">Summary</p>
//                 <select
//                   className="h-6 mt-1 px-3 text-[9px] text-white bg-black-700 border-none outline-none cursor-pointer"
//                   value={summaryFilter}
//                   onChange={e => setSummaryFilter(e.target.value)}
//                 >
//                   <option value="today">Today</option>
...
//                 <div className='w-[1px] h-full bg-gray-500'></div>
//                 <div>
//                   <p className="text-xs text-white text-opacity-50">Profit/Loss</p>
//                   <div className="flex items-center gap-1.5 mt-3">
//                     <img src="/Images/Icons/decrease.svg" alt="decrease" />
//                     <p className="text-[10px] text-red-400 leading-none">-157.02</p>
//                   </div>
//                 </div>
//                 <div>
//                   <p className="text-xs text-white text-opacity-50">Size</p>
//                   <p className="text-[10px] text-white mt-3">0.01</p>
//                 </div>
//                 <div>
//                   <p className="text-xs text-white text-opacity-50">Withdrawal</p>
//                   <p className="text-[10px] text-white mt-3">-USD$15</p>
//                 </div>
//                 <div className='w-[1px] h-full bg-gray-500'></div>
//               </div>
//             </div>
//           )}
//           <button onClick={handleOpenDialog} className="border border-white py-1 px-5 rounded-lg text-white hidden lg:flex">
//             Close all trades
//           </button>
//         </div>
//       </div>
...
//           <div ref={dropdownref} className={`fixed bottom-0 left-0 md:relative ${isClosing ? "lg:animate-slideUp animate-slideUpSmall" : "lg:animate-slideDown animate-slideDownSmall"}`}>
//             <CloseTradesDialog onClose={handleCloseDialog} />
//           </div>
//         </div>
//       )}
