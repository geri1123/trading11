 ...
 const handleBuy = async (): Promise<void> => {
  ...
  try {
    const tradeData = {
      ...
      riskEnabled: true,
      pendingEntryPrice: data.ask, // or any other logic
      pendingOrderType: "LIMIT",   // assuming a default type
      pending: false               // or true, depending on logic
    };

    await createOrder(tradeData); // use createOrder instead of createTrade if targeting /api/orders
